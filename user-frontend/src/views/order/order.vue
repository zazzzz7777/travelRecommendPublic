    ...
    <el-dialog title="预约详情" :visible.sync="dialogVisible" width="40%">
      <span>
        <div style="margin-bottom: 10px">
          <el-button size="mini" type="primary" plain v-if="state == 0"
            >未确认</el-button
          >
          <el-button size="mini" type="primary" plain v-if="state == 1"
            >已确认</el-button
          >
          <el-button size="mini" type="primary" plain v-if="state == 2"
            >取消中</el-button
          >
          <el-button size="mini" type="primary" plain v-if="state == 3"
            >已取消</el-button
          >
          <el-button size="mini" type="primary" plain v-if="state == 4"
            >取消失败</el-button
          >
          <el-button size="mini" type="primary" plain v-if="state == 5"
            >已使用</el-button
          >
        </div>
        <el-input-number
...
export default {
  ...
  mounted() {
    ...
    this.search1.userId = JSON.parse(
